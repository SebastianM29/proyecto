...
router.post('/register',passport.authenticate('register',{successRedirect:'https://proyecto-production-1d58.up.railway.app/login',failureRedirect:'https://proyecto-production-1d58.up.railway.app/register'}) )
router.get('/github',passport.authenticate('github',{scope:['user:email']}),async(req,res)=>{
  
})
//el que usa github
router.get('/githubcallback',passport.authenticate('github',{failureRedirect:'https://proyecto-production-1d58.up.railway.app/login'}),async(req,res)=>{
...
router.post('/login',passport.authenticate('login',{
      failureRedirect:'https://proyecto-production-1d58.up.railway.app/login'
}), login)
